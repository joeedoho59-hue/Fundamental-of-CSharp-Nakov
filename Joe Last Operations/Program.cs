...
namespace Joe_Last_Operations
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Enter a decimal number: ");
            int decimalNumberHex = int.Parse(Console.ReadLine());
            string hexadecimalNumber = decimalNumberHex.ToString("X");
            Console.WriteLine("Hexadecimal representation: " + hexadecimalNumber);

            // Decimal to Octal Conversion
            Console.WriteLine("Enter a decimal number: ");
            int decimalNumberOct = int.Parse(Console.ReadLine());
            string octalNumber = Convert.ToString(decimalNumberOct, 8);
            Console.WriteLine("Octal representation: " + octalNumber);
